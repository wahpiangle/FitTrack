...
//exercises
  ...
  void addExerciseToList(Exercise exercise) {
    ...
    // Save the updated list back to the ObjectBox
    _exerciseBox.removeAll(); // Clear the existing exercises
    _exerciseBox.putMany(exercises); // Put the updated list of exercises
  }
