...
class _WorkoutScreenState extends State<WorkoutScreen> {
  ...
  late List<Exercise> exerciseData; // Declare exerciseData here

  @override
  void initState() {
    super.initState();
    exerciseData = generateExerciseData(); // Generate exercise data
  }
                      ...
                      child: TextButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => StartNewWorkout(exerciseData: exerciseData),
                            ),
                          );
                        },
                        style: ButtonStyle(
                          backgroundColor: MaterialStateProperty.all(const Color(0xFFC1C1C1)),
