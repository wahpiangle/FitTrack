...
class SetTileWeighted extends StatefulWidget {
  ...
  @override
  State<SetTileWeighted> createState() => _SetTileState();
}

class _SetTileState extends State<SetTileWeighted > {
  int? recentWeight;
  int? recentReps;
