...
class SetTileAssisted extends StatefulWidget {
  ...
  @override
  State<SetTileAssisted> createState() => _SetTileAssistedState();
}

class _SetTileAssistedState extends State<SetTileAssisted> {
  int? recentWeight;
  int? recentReps;
